...
| **D4** | 09-21 一 | **L4b 选型 + 协同** | "LangGraph 和 Hermes 是同层二选一" + 多智能体 vs 单 agent | 框架选型矩阵终版 + runtime 五方对照表（LangGraph/Hermes/waku/pi/DSH） | `运行时选型-LangGraph-vs-Hermes.md` ✅ 312 行 + `运行时选型深度解析\Runtime_Five_Way_Deep_Dive.md` ✅ 713 行 |
